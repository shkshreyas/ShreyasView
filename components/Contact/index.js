            ...
            <form onSubmit={submitHandler} className="group p-2 justify-center items-center md:items-start gap-5 md:gap-10 lg:gap-14 flex flex-col md:flex-row md:p-10 mx-auto min-w-fit">
                <div className="space-y-5 text-center">
                    ...
                    <div className="text-3xl flex flex-wrap justify-center gap-5 ">
                        <Link href="mailto:shkshreyaskumar@gmail.com"><a className="hover:scale-110 transition duration-400 ease-in-out" target="_blank"><HiOutlineMail /></a></Link>
                        <Link href="https://www.linkedin.com/in/shkshreyas/"><a className="hover:scale-110 transition duration-400 ease-in-out" target="_blank"><FaLinkedin /></a></Link>
                        <Link href="https://github.com/shkshreyas"><a className="hover:scale-110 transition duration-400 ease-in-out" target="_blank"><FaGithub /></a></Link>
                    </div>
                    <Zoom delay={300}>

    ...
    return (
        <div id="skills" className={`mx-auto p-5 md:px-10 bg-gradient-to-br flex-1 dark:from-slate-900 items-center dark:via-gray-900 dark:to-black flex flex-col lg:flex-row overflow-hidden justify-center`}>
            <div className="xl:ml-14 md:px-10 space-y-8 md:space-y-12 lg:max-w-[50vw] text-center">
                <a className="max-w-min whitespace-nowrap animated-underline md:after:bg-sky-700 md:dark:after:bg-slate-300 tracking-wide hover:tracking-widest duration-300 transform ease-in-out md:after:h-1 text-center text-5xl font-bold link-glow">
                    My Skills
                </a>
                <div className="group">
                ...
                <div className="">
                    ...
                    <div className="text-start mt-3">
                        ...
                        <div className="flex gap-2 flex-wrap mt-3">
                            ...
                            <a className="bg-opacity-90 bg-[#0c111f] text-[#62baf2] border-2 border-[#62baf2] px-4 py-2 font-semibold whitespace-nowrap max-w-min rounded-xl cursor-pointer">Flutter</a>
                            ...
                            <a className="bg-opacity-90 bg-[#4C51BF] text-[#fff]/90 border-2 border-[#fff]/70 px-4 py-2 font-semibold whitespace-nowrap max-w-min rounded-xl cursor-pointer">Jetpack Compose</a>
                            <a className="bg-opacity-90 bg-[#1E88E5] text-[#fff]/90 border-2 border-[#fff]/70 px-4 py-2 font-semibold whitespace-nowrap max-w-min rounded-xl cursor-pointer">Kotlin</a>
                            <a className="bg-opacity-90 bg-[#FF5722] text-[#fff]/90 border-2 border-[#fff]/70 px-4 py-2 font-semibold whitespace-nowrap max-w-min rounded-xl cursor-pointer">Android Studio</a>
                            <a className="bg-opacity-90 bg-[#4CAF50] text-[#fff]/90 border-2 border-[#fff]/70 px-4 py-2 font-semibold whitespace-nowrap max-w-min rounded-xl cursor-pointer">Deep Learning</a>
                            <a className="bg-opacity-90 bg-[#9C27B0] text-[#fff]/90 border-2 border-[#fff]/70 px-4 py-2 font-semibold whitespace-nowrap max-w-min rounded-xl cursor-pointer">Machine Learning</a>
                        </div>
                    </div>
                    <div className="text-start mt-3">
                        ...
                        <div className="flex gap-2 flex-wrap mt-3">
                            ...
                            <a className="border-2 border-yellow-600 text-yellow-600 dark:text-yellow-300 dark:border-yellow-300 px-4 py-2 font-semibold whitespace-nowrap max-w-min rounded-xl cursor-pointer">Javascript/Java</a>
